...
public class ReportCommand implements Command {
    public static void command(Catalog catalog) throws InvalidCommandException, InvalidDataException {
        ...
        try {
            config.setDirectoryForTemplateLoading(new File(ReportCommand.class.getResource("/templates").toURI()));
        }
        catch (IOException e) {
